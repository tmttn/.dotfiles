...
plugins=(zsh-ssh git asdf z _mvnctx colored-man-pages colorize command-not-found docker docker-compose npm mvn zsh-autosuggestions gradle-completion   zsh-npm-scripts-autocomplete tmux)
...
prompt_git() {
  ...
  local ref dirty mode repo_path
   ...
   if [[ "$(git rev-parse --is-inside-work-tree 2>/dev/null)" = "true" ]]; then
    ...
    vcs_info
    echo -n "%20>…>${${ref:gs/%/%%}/refs\/heads\//$PL_BRANCH_CHAR }%>>${vcs_info_msg_0_%% }${mode}"
  fi
}
